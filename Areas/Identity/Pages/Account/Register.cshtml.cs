...
namespace SistemaDeReservas.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    Email = Input.Email,
                    NombreCompleto = Input.NombreCompleto // 👈 se guarda aquí
                };
            ...
            // Si falla, volver a mostrar formulario
            return Page();
        }
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("El administrador de usuarios no admite correos electrónicos.");
            }
